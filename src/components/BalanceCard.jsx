  ...
  return (
    <>
      <div className="balance-card-gradient flex min-h-[200px] w-full max-w-sm flex-col justify-between rounded-[20px] px-6 py-4 text-white">
        ...
        <button 
          className="flex cursor-pointer items-center justify-center rounded-xl bg-white py-2 font-semibold shadow transition hover:bg-gray-50 active:bg-gray-100"
      ...
      <WithdrawalModal
        ...
        hasAccounts={false} // Set this based on your actual accounts state
      />
    </>
  );
}
