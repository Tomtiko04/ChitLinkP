...
const CompanyInfoForm = ({ register, errors, prevStep, handleSubmit }) => {
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        />
        {errors.companyName && <p className="animate-shake mt-1 text-xs text-[#A73957]">{errors.companyName.message}</p>}
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="w-full rounded-xl bg-[#F8F8F8] px-6 py-3 text-base font-normal text-[#22180E99] transition-colors duration-300 placeholder:text-[#22180E99]/60 hover:bg-[#FFF4DD]/50 focus:bg-[#FFF4DD] focus:outline-none sm:px-6 sm:py-3"
        />
        {errors.address && <p className="animate-shake mt-1 text-xs text-[#A73957]">{errors.address.message}</p>}
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="w-full rounded-xl bg-[#F8F8F8] px-6 py-3 text-base font-normal text-[#22180E99] transition-colors duration-300 placeholder:text-[#22180E99]/60 hover:bg-[#FFF4DD]/50 focus:bg-[#FFF4DD] focus:outline-none sm:px-6 sm:py-3"
        />
        {errors.regNumber && <p className="animate-shake mt-1 text-xs text-[#A73957]">{errors.regNumber.message}</p>}
      </div>
      ...
      <div>
        ...
        />
        {errors.cacCertificate && <p className="animate-shake mt-1 text-xs text-[#A73957]">{errors.cacCertificate.message}</p>}
      </div>
